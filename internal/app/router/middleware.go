...
func CORSMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.Writer.Header().Set("Access-Control-Allow-Origin", "same-origin") //"*"
		c.Writer.Header().Set("cross-origin-opener-policy-report-only", "same-origin; report-to=\"coop_gse_qebhlk\"")
